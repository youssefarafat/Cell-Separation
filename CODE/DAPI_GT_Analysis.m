...
title(strcat('A=',32,num2str(dataOut.Accuracy,2),',J=',32,num2str(dataOut.Jaccard,2),',D=',num2str(dataOut.DICE_measure,2),',Cells/GT=',num2str(dataOut.numCentral,2),'/',num2str(dataOut.num_GTCells,2)))
