...
subplot(2,4,2)
h(2) = imagesc(red_channelR_filt)
h(2) = gca;

subplot(2,4,3)
h(3) = imagesc(red_channelR_thres)
h(3) = gca;

subplot(2,4,4)
h(4) = imagesc(red_channelR_labelled)
h(4) = gca;

subplot(2,4,5)
h(5) = imagesc(red_channelR_filled)
h(5) = gca;

subplot(2,4,6)
h(6) = imagesc(red_channelR_clean)
h(6) = gca;

subplot(2,4,7)
h(7) = imagesc(red_channelR_closed)
h(7) = gca;
